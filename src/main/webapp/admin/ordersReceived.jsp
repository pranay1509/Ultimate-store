          ...
          <th>Mobile Number</th>
            ...
            <th scope="col">Order Date</th>
             ...
             <th scope="col">Payment Method</th>
              ...
              <th scope="col">Deliver order <i class='fas fa-dolly'></i></i></th>
          </tr>
<%
try
{
             ...
             <td><%=rs.getString(11) %></td>
              <td><%=rs.getString(12) %></td>
               ...
               <td><a href="cancelOrdersAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Cancel <i class='fas fa-window-close'></i></a></td>
                <td><a href="deliverOrdersAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Deliver <i class='fas fa-dolly'></i></i></a></td>
            </tr>
<%}	
}
catch(Exception e)
